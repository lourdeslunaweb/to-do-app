const FinishedTaskCard = () => {
    return (
        <div className="card border-success mb-3 mt-5 mx-3 col-lg-3 col-md-4 col-10">
            <div className="card-body">
                ...
                <div className="form-group">
                    ...
                    <div className="mt-5 d-flex justify-content-evenly">
                        <button type="button" className="btn btn-outline-success">Actualizar</button>
